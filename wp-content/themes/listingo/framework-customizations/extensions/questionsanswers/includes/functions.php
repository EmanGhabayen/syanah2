        ...
        <ul class="tg-postmatadata">
            ...
            <li>
                <a href="javascript:;">
                    ...
                    <span><?php printf( _x( '%s Ago', '%s = human-readable time difference', 'listingo' ), human_time_diff( get_the_time( 'U' ), current_time( 'timestamp' ) ) ); ?></span>
                </a>
            </li>
        </ul>
        <?php
        ...
        <ul class="tg-votesanswers">
            <li>
                <a href="javascript:;">
                    ...
                    <em><?php esc_html_e('votes', 'listingo'); ?></em>
                </a>
            </li>
            ...
            <?php if ($skip_ans === 'no') { ?>
                <li>
                    <a href="javascript:;">
                        ...
                        <em><?php esc_html_e('answers', 'listingo'); ?></em>
                    </a>
                </li>
        <?php } ?>
        </ul>
