...
<div class="sp-sc-articles tg-haslayout">
	...
	<div class="tg-newsandposts tg-bloggird">
		<div class="row">
						...
						<article class="tg-post">
							...
							<div class="tg-serviceprovidercontent">
								...
								<div class="tg-companycontent">
									...
									<h3><?php  echo '<time datetime="' . date('Y-m-d', strtotime(get_the_date('Y-m-d', $post->ID))) . '"><span>' . date(get_option('date_format'), strtotime(get_the_date('Y-m-d', $post->ID))) . '</span></time>';;?></h3>
								</div>
							</div>
						</article>
					</div>
			...
			?>
			<?php if ( isset($atts['show_pagination']) && $atts['show_pagination'] == 'yes' && $found_posts > $show_posts ) : ?>
				<div class="col-md-12">
