...
$containerstart	= '';
$containerend	= '';
$classes		= 'sp-map-display'; 
if( isset( $search_page_map ) && $search_page_map === 'disable' ){
...
<div class="tg-listing tg-listview tg-listingvtwo sp-search-left <?php echo esc_attr( $classes );?>">
	<?php echo ( $containerstart );?>
